			...
			<body>
				...
				<div id="intro">
					<p>
						...
						It was generated using the Blogging-Software <a href="http://logpress.sinaapp.com" title="logpress">logpress</a> .<br />
				...
				<div id="footer">
					Generated with <a href="http://logpress.sinaapp.com" title="logpress">logpress</a>, powered by <a href="http://sae.sina.com.cn" title="Sina App Engine">Sina App Engine</a>. This XSLT template is released understand GPL.
				</div>
			</body>
		</html>
	</xsl:template>
